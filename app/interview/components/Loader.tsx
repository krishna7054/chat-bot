export default function Loader() {
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-white/70 bg-white/70 px-4 py-3 text-sm text-(--muted) shadow-[0_12px_28px_rgba(88,61,31,0.08)] backdrop-blur">
